...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        function validateField(field) {
            ...
            var errorElement = field.parentElement.querySelector('.form-error');
            ...
            if (field.hasAttribute('required') && value === '') {
                errorElement.textContent = field.getAttribute('data-error-required') || 'This field is required';
            ...
            if (field.type === 'email' && value !== '') {
                ...
                if (!emailRegex.test(value)) {
                    errorElement.textContent = field.getAttribute('data-error-email') || 'Please enter a valid email address';
                    field.classList.add('input-error');
                    return false;
                }
            }
            ...
            if (field.hasAttribute('minlength') && value.length < parseInt(field.getAttribute('minlength'))) {
                errorElement.textContent = field.getAttribute('data-error-minlength') || 'Minimum ' + field.getAttribute('minlength') + ' characters required';
                field.classList.add('input-error');
                return false;
            }
            ...
            if (field.hasAttribute('pattern') && value !== '') {
                ...
                if (!pattern.test(value)) {
                    errorElement.textContent = field.getAttribute('data-error-pattern') || 'Invalid format';
                    field.classList.add('input-error');
                    return false;
                }
            }
                ...
                if (submitButton) {
                    ...
                    .then(function(response) {
                        if (response.ok) {
                            ...
                            successMessage.style.cssText = 'color: #38a169; padding: 1rem; margin-top: 1rem; background: #f0fff4; border-radius: 0.375rem;';
                            contactForm.insertAdjacentElement('afterend', successMessage);
                            contactForm.reset();
                            
                            fields.forEach(function(f) {
                                f.classList.remove('input-valid');
                            });
                    ...
                    .catch(function() {
                        ...
                        errorMessage.style.cssText = 'color: #e53e3e; padding: 1rem; margin-top: 1rem; background: #fff5f5; border-radius: 0.375rem;';
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (field && (field.classList.contains('input-error') || field.classList.contains('input-valid'))) {
                validateField(field);
            }
        });
    ...
    if (animatedElements.length > 0) {
        ...
        style.textContent = '.fade-in.visible,.fade-in-up.visible,.fade-in-left.visible,.fade-in-right.visible{opacity:1!important;transform:translate(0)!important}';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'bab3c1e1-1c79-47ee-a497-6e82688281ee',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'bab3c1e1-1c79-47ee-a497-6e82688281ee';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'bab3c1e1-1c79-47ee-a497-6e82688281ee';
